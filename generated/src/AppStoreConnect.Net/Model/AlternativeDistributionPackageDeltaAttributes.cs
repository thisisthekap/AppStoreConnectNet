...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class AlternativeDistributionPackageDeltaAttributes : IValidatableObject
    {
        ...
        public AlternativeDistributionPackageDeltaAttributes(string url = default(string), DateTimeOffset urlExpirationDate = default(DateTimeOffset), string alternativeDistributionKeyBlob = default(string), string fileChecksum = default(string))
        {
            this.Url = url;
