...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class GameCenterMatchmakingRuleAttributes : IValidatableObject
    {
        ...
        public GameCenterMatchmakingRuleAttributes(string referenceName = default(string), string description = default(string), TypeEnum? type = default(TypeEnum?), string expression = default(string), decimal weight = default(decimal))
        {
