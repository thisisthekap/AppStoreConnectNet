...
namespace AppStoreConnect.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GameCenterLeaderboardSet_attributes")]
    public partial class GameCenterLeaderboardSetAttributes : IValidatableObject
    {
        /// <summary>
        ...
        public GameCenterLeaderboardSetAttributes(string referenceName = default(string), string vendorIdentifier = default(string))
        {
