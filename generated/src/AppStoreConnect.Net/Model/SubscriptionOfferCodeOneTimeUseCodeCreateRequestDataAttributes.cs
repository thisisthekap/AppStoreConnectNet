...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class SubscriptionOfferCodeOneTimeUseCodeCreateRequestDataAttributes : IValidatableObject
    {
        /// <summary>
        ...
        public SubscriptionOfferCodeOneTimeUseCodeCreateRequestDataAttributes(int numberOfCodes = default(int), DateOnly expirationDate = default(DateOnly))
        {
