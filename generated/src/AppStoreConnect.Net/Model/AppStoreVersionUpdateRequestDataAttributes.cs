...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class AppStoreVersionUpdateRequestDataAttributes : IValidatableObject
    {
        ...
        public AppStoreVersionUpdateRequestDataAttributes(string versionString = default(string), string copyright = default(string), ReviewTypeEnum? reviewType = default(ReviewTypeEnum?), ReleaseTypeEnum? releaseType = default(ReleaseTypeEnum?), DateTimeOffset earliestReleaseDate = default(DateTimeOffset), bool downloadable = default(bool))
        {
