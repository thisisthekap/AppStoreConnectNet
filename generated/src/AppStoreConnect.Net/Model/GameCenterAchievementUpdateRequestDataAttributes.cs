...
namespace AppStoreConnect.Net.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GameCenterAchievementUpdateRequest_data_attributes")]
    public partial class GameCenterAchievementUpdateRequestDataAttributes : IValidatableObject
    {
        /// <summary>
        ...
        public GameCenterAchievementUpdateRequestDataAttributes(string referenceName = default(string), int points = default(int), bool showBeforeEarned = default(bool), bool repeatable = default(bool), bool archived = default(bool))
        {
