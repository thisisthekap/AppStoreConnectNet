...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class GameCenterLeaderboardEntrySubmissionAttributes : IValidatableObject
    {
        ...
        public GameCenterLeaderboardEntrySubmissionAttributes(string bundleId = default(string), List<string> challengeIds = default(List<string>), decimal context = default(decimal), string scopedPlayerId = default(string), decimal score = default(decimal), DateTimeOffset submittedDate = default(DateTimeOffset), string vendorIdentifier = default(string))
        {
