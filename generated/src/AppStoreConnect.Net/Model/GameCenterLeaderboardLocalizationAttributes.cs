...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class GameCenterLeaderboardLocalizationAttributes : IValidatableObject
    {
        ...
        public GameCenterLeaderboardLocalizationAttributes(string locale = default(string), string name = default(string), GameCenterLeaderboardFormatter? formatterOverride = default(GameCenterLeaderboardFormatter?), string formatterSuffix = default(string), string formatterSuffixSingular = default(string))
        {
            this.Locale = locale;
            this.Name = name;
