...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class GameCenterLeaderboardLocalizationUpdateRequestDataAttributes : IValidatableObject
    {
        ...
        public GameCenterLeaderboardLocalizationUpdateRequestDataAttributes(string name = default(string), GameCenterLeaderboardFormatter? formatterOverride = default(GameCenterLeaderboardFormatter?), string formatterSuffix = default(string), string formatterSuffixSingular = default(string))
        {
            this.Name = name;
