...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class GameCenterLeaderboardUpdateRequestDataAttributes : IValidatableObject
    {
        ...
        public GameCenterLeaderboardUpdateRequestDataAttributes(GameCenterLeaderboardFormatter? defaultFormatter = default(GameCenterLeaderboardFormatter?), string referenceName = default(string), SubmissionTypeEnum? submissionType = default(SubmissionTypeEnum?), ScoreSortTypeEnum? scoreSortType = default(ScoreSortTypeEnum?), decimal scoreRangeStart = default(decimal), decimal scoreRangeEnd = default(decimal), DateTimeOffset recurrenceStartDate = default(DateTimeOffset), string recurrenceDuration = default(string), string recurrenceRule = default(string), bool archived = default(bool))
        {
