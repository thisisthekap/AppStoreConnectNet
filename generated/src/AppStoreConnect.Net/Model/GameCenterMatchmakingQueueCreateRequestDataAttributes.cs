...
namespace AppStoreConnect.Net.Model
{
    ...
    public partial class GameCenterMatchmakingQueueCreateRequestDataAttributes : IValidatableObject
    {
        ...
        public GameCenterMatchmakingQueueCreateRequestDataAttributes(string referenceName = default(string), List<string> classicMatchmakingBundleIds = default(List<string>))
        {
