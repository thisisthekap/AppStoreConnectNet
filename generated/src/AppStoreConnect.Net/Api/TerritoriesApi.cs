...
namespace AppStoreConnect.Net.Api
{
    ...
    public interface ITerritoriesApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<TerritoriesResponse> TerritoriesGetCollectionAsync(List<string>? fieldsTerritories = default(List<string>?), int? limit = default(int?), System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<TerritoriesResponse>> TerritoriesGetCollectionWithHttpInfoAsync(List<string>? fieldsTerritories = default(List<string>?), int? limit = default(int?), System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken));
    ...
    public partial class TerritoriesApi : IDisposable, ITerritoriesApi
    {
        ...
        /// <param name="limit">maximum resources per page (optional)</param>
        /// <returns>ApiResponse of TerritoriesResponse</returns>
        public AppStoreConnect.Net.Client.ApiResponse<TerritoriesResponse> TerritoriesGetCollectionWithHttpInfo(List<string>? fieldsTerritories = default(List<string>?), int? limit = default(int?))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of TerritoriesResponse</returns>
        public async System.Threading.Tasks.Task<TerritoriesResponse> TerritoriesGetCollectionAsync(List<string>? fieldsTerritories = default(List<string>?), int? limit = default(int?), System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
        {
